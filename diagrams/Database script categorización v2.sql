...
DROP TABLE IF EXISTS `ResiduosSolidos`;
CREATE TABLE IF NOT EXISTS `ResiduosSolidos` (
...
DROP TABLE IF EXISTS `SustanciasAux`;
CREATE TABLE IF NOT EXISTS `SustanciasAux` (
...
DROP TABLE IF EXISTS `SustanciasAuxYFluidos`;
CREATE TABLE IF NOT EXISTS `SustanciasAuxYFluidos` (
...
DROP TABLE IF EXISTS `InmueblesAnexos`;
CREATE TABLE IF NOT EXISTS `InmueblesAnexos` (
...
ALTER TABLE `Domicilio` ADD FOREIGN KEY (`localidad`) REFERENCES `Localidades`(`id`);
...
ALTER TABLE `Localidades` ADD FOREIGN KEY (`id_departamento`) REFERENCES `Departamentos`(`id_departamento`);
ALTER TABLE `Localidades` ADD FOREIGN KEY (`id_nodo`) REFERENCES `Nodos`(`id_nodo`);
COMMIT;
